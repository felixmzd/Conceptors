...
def test_same_binocular_pickle(shared_datadir):
    ...
    original_pickle = pickle.load(open(shared_datadir / 'FigureObject.fig_result_old.pickle', 'rb'))
    new_pickle = pickle.load(open(shared_datadir / 'FigureObject.fig_result.pickle', 'rb'))
