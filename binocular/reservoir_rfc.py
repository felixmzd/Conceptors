...
class ReservoirRFC:
    ...
    def __init__(self, N = 100, M = 500, alpha = 8, NetSR = 1.4, bias_scale = 0.2, inp_scale = 1.2):
        ...
        while not succ:
            try:
                ...
                print('Retryingto generate internal weights.')
                pass
    ...
    def run(self, patterns, t_learn = 400, t_learnc = 2000, t_wash = 200, TyA_wout = 1, TyA_wload = 0.01,
        ...
        self.patterns = patterns; self.t_learn = t_learn; self.t_learnc = t_learnc; self.t_wash = t_wash; self.TyA_wout = TyA_wout; self.TyA_wload = TyA_wload
        self.gradient_load = gradient_load; self.c_adapt_rate = c_adapt_rate
